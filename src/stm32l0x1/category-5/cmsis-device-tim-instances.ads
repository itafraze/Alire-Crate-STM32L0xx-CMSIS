...
package CMSIS.Device.TIM.Instances is
   ...
   --    - cmsis_device_l0:Include/stm32l081xx.h
   ...
   function Supports_DMA_Update (Instance : All_Instance_Type)
      return Boolean is
      (Instance in TIM2 | TIM3 | TIM6 | TIM7)
      with Inline;
   ...
   function Supports_Outputs (Instance : All_Instance_Type;
      ...
      return Boolean is
      (((Instance in TIM2 | TIM3) and then Channel'Valid)
